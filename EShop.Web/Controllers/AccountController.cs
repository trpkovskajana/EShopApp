...
namespace EShop.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        private readonly UserManager<EShopApplicationUser> userManager; // registracija na korisnikot
        private readonly SignInManager<EShopApplicationUser> signInManager; // login na korisnikot
